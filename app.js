...
async function main() {
    await mongoose.connect('mongodb+srv://divyagrawal29:Divyidhack1@cluster0.bdqsvuv.mongodb.net/blogPostDB', { useNewUrlParser: true, useUnifiedTopology: true });
}
...
app.get("/posts/:textUrl", (req, res) => {
  postsArrayApp.forEach((element) => {
    if (_.lowerCase(element.title) === _.lowerCase(req.params.textUrl)) 
    {
      res.render("post", {
        title: element.title,
        body: element.body
